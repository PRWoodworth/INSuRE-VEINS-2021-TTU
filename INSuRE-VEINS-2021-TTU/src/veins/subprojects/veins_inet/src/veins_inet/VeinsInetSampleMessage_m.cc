...
//TODO
const char * VeinsInetSampleMessage::getMessageType() const{
    return this->messageType.c_str();
}
void VeinsInetSampleMessage::setMessageType(const char * type){
    messageType = type;
}
...
bool VeinsInetSampleMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        //TODO
        case FIELD_messageType: pp->setMessageType((value)); return true;
